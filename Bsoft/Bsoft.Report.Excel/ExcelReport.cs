    ...
    public class ExcelReport
    {
        ...
        private string WriteReport()
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    MessageBoxMy.Show("The file your are trying to use is in open ,Please close it first.");
                    return "";
                }
                ...
                if (i >= 1)
                {
                    MessageBoxMy.Show(Language.LanguageString.ExporttoExcelSuccessFull, MessageBoxButtons.OK);
                }
            }
            return saveFileDialog1.FileName;
        }

        public string WriteReport(string filename)
        {
        ...
        #endregion Main Function For Exporting
