...
namespace UEMS.MasterEntry
{
    ...
    public partial class frmCompanyOption2 : Bsoft.Design.EntryFromDesignBase
    {
        public frmCompanyOption2()
        {
            InitializeComponent();
        ...
        private void frmCompany_Load(object sender, EventArgs e)
        {
            ...
            txtVatNo.Text = ConstantValues.VATNo.ToString();
            txtPanNo.Text = ConstantValues.PANNo.ToString();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            ConstantValues.PANNo = txtPanNo.Text;
            ConstantValues.VATNo = txtVatNo.Text;
