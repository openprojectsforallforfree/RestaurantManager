...
AppId={{B5E65BEE-7F06-4616-9C31-58E736276856}}
AppName=Restaurant System
AppVerName=Restaurant System V2
AppPublisher=Picasso Consultant
DefaultDirName=D:\Software\RestaurantSystem
DefaultGroupName=Restaurant System
InfoBeforeFile=..\WriteUps\PasalSystem.txt
OutputDir=..\SetupOutput
OutputBaseFilename=Restaurant System Setup
Compression=lzma
...
[Files]
Source: "..\Build\Restosys.exe"; DestDir: "{app}"; DestName: "Restosys.exe"; Flags: ignoreversion
...
Source: "..\Configs\RestaurantSys.exe.config"; DestDir: "{app}"; DestName: "Restosys.exe.config"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: {group}\Restaurant System; Filename: {app}\Restosys.exe; WorkingDir: {app}; IconIndex: 0
Name: {commondesktop}\Restaurant System; Filename: {app}\Restosys.exe; Tasks: desktopicon; WorkingDir: {app}; IconIndex: 0

[Run]
Filename: {app}\Restosys.exe; Description: {cm:LaunchProgram,Restaurant System}; Flags: nowait postinstall skipifsilent
