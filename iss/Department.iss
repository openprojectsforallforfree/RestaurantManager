...
AppId={{BF43298A-F885-4458-B686-189C8DC7208A}}
AppName=Department System
AppVerName=Department System V2
AppPublisher=Picasso Consultant
DefaultDirName=D:\Software\Department System
DefaultGroupName=Department System
InfoBeforeFile=..\WriteUps\PasalSystem.txt
OutputDir=..\SetupOutput
OutputBaseFilename=Department System Setup
Compression=lzma
...
[Files]
Source: "..\Build\Restosys.exe"; DestDir: "{app}"; DestName: "DepartmentSys.exe"; Flags: ignoreversion
...
Source: "..\Configs\DepartmentSys.exe.config"; DestDir: "{app}"; DestName: "Restosys.exe.config"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
Name: {group}\Department System; Filename: {app}\DepartmentSys.exe; WorkingDir: {app}; IconIndex: 0
Name: {commondesktop}\Department System; Filename: {app}\DepartmentSys.exe; Tasks: desktopicon; WorkingDir: {app}; IconIndex: 0

[Run]
Filename: {app}\DepartmentSys.exe; Description: {cm:LaunchProgram,Department System}; Flags: nowait postinstall skipifsilent
