...
fk_NGO Integer,
fk_Person Integer,
fk_Person_Role Integer,CONSTRAINT FK_NGO_fk_NGO FOREIGN KEY (fk_NGO) REFERENCES NGO (Id), 
...
TaskDate varchar(15),
Remarks varchar,
RFU varchar,CONSTRAINT FK_YearlyReport_fk_YearlyReport FOREIGN KEY (fk_YearlyReport) REFERENCES YearlyReport (Id), 
