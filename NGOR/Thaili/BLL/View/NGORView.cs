...
namespace UEMS.BLL.View
{
    class NGORView
    {
        ...
        public static string _IptServerDate = string.Empty;
        ...
        {
            if (!GlobalResources.DbStruct.DoesViewExists("IndividualPersonView"))
            {
                createAView("IndividualPersonView", @"
                        select 
                        p.Id as PersonId,
                        ...
                        info.Phone as Phone,
                        info.Email as Email,
                        p.fk_Ethnicity as fk_Ethnicity,
                        ethnicity.title as Ethnicity
                        from  individualperson p 
                        ...
                        left join Master_Ethnicity ethnicity on ethnicity.id = p.fk_Ethnicity");
...
from ngo_member n 
left join person_role r on n.fk_person_role = r.id
left join individualpersonview i on i.PersonId = n.fk_person             
