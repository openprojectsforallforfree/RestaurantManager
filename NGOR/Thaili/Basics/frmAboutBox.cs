...
namespace UEMS
{
    public partial class frmAboutBox : Form 
    {
        ...
        private Loader _objLoader = new Loader();
        private bool _isSplash = true;
        #endregion
        public frmAboutBox(bool isSplash):base()
        {
        ...
        public frmAboutBox()
        {
            ...
            GlobalValues.DbPath =Bsoft.Data.DataGeneral .GetPathFromConnectionstring ( UEMS.Properties.Settings.Default.Configstring );
