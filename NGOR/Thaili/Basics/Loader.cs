...
namespace UEMS.BLL
{
    ...
    public class Loader
    {
        ...
        public void LoadNecessaryObjects()
        {
            ...
            if (Commands.updateDb)
            {
                //From Appcom
                (new ChangeBasicDBStructure()).UpdateStructure();
                (new FiscalYearDML()).UpdateStructure();
                (new DMLUserRightsSimple()).UpdateStructure((new MainForm()).menuStrip1);
                ChangeDBStructure cdb= new ChangeDBStructure();
                cdb.BasicDb();
                cdb.createAddressDataStructure ();
                cdb.createBasicDataStructure ();
                cdb.UpdateStructure();
                cdb.CreateGeneralDb ();
                cdb.createNgorMasterDataStructure ();
                cdb.CreateUserRightsSimple ();
                cdb.JoinDb ();
                cdb.otherMaster();
